...
relatedItem = type.toLocal8Bit(); \
	...
	bookSummary->setMinimumWidth(680); \
	reviewArea->setMinimumWidth(900); \
...
QStringList getInfo(QString);

void writeDB(QString, QString, QString, QString, QString, QString);
QString getUser_now();
QString getPass_now();
...
QString getbookID(QString);
QStringList getBookInfo(QString);

bool checkAccAvailable(QString);
int getBorrowNum(QString);
int getRequestNum(QString);
bool checkRequestExist(QString, QString);